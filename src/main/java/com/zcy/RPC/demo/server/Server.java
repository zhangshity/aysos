package com.zcy.RPC.demo.server;

import com.zcy.RPC.demo.data.RpcRequest;
import com.zcy.RPC.demo.data.RpcResponse;
import com.zcy.RPC.demo.service.TestService;
import com.zcy.RPC.demo.service.impl.TestServiceImpl;
import com.zcy.RPC.demo.zookeeper.ZookeeperUtils;
 ...
 * @ Description:
 * @ Date: Created in 16:05 2019-08-14
 * @ Modified: By:
 */
public class Server {
    ...
    //接口，这里方便测试用
    private String serviceName = TestService.class.getName();
    //地址目录
...
//        //模拟spring容器的加载过程
//        RpcBeanFactory.putBean(TestService.class.getName(), new TestServiceImpl());
