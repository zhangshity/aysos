package com.zcy.RPC.demo.client;
 ...
 * @ Description:
 * @ Date: Created in 16:04 2019-08-14
 * @ Modified: By:
 */
public class Client {
    //缓存地址
...
//        RpcBeanFactory.putBean("testService", client.createProxy(TestService.class.getName()));
//        //获取bean的过程，实际上实现是代理接口的实现
//        TestService testService = (TestService) RpcBeanFactory.getBean("testService");
//        //调用方法，也就是调用代理的过程
